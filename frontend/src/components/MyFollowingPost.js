        ...
        <div className='card' key={post._id}>
          <div className='card-header'>
            <div className='card-pic'>
              <img src='https://media.istockphoto.com/id/1318988756/photo/studio-portrait-of-a-young-businesswoman.jpg?s=612x612&w=is&k=20&c=UUdmfJOnKOGPKW4HYwxFkqth0KcTvh-wU9h_hfH4LVc=' alt='Profile Pic' />
            </div>
            <h5>
          ...
          <div className='card-image'>
            {post.photo.endsWith('.mp4') || post.photo.endsWith('.webm') || post.photo.endsWith('.ogg') ? (
              <video controls src={post.photo} alt='Video' onClick={() => openFullScreen(post.photo)} />
            ) : (
              <img src={post.photo} alt='Post' onClick={() => openFullScreen(post.photo)} />
            )}
          </div>
        ...
        <div className='showComment'>
          <div className='container'>
            <div className='postPic'>
              {item.photo.endsWith('.mp4') || item.photo.endsWith('.webm') || item.photo.endsWith('.ogg') ? (
